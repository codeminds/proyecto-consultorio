   ...
   public class AppointmentValidator : IAppointmentValidator
   {
      ...
      public bool ValidateInsert(InsertUpdateAppointmentDTO data, List<string> messages)
      {
         ...
         else
         {
            ...
            Las citas tienen una duración de 1 hora, así que no puede haber una cita que empiece en medio de otra cita, al igual que no puede
            haber una cita que empiece antes pero durante su diración se traslape con otra cita. */
