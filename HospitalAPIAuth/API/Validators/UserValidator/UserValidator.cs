...
namespace API.Validators
{
    public class UserValidator : IUserValidator
    {
        ...
        public bool ValidateInsertUpdate(int? id, InsertUpdateUserDTO data, bool isSuperAdmin, List<string> messages)
        {
            List<string> innerMessages = new();

            if (id.HasValue && !isSuperAdmin && this._database.User.Any(u => u.Id == id && u.RoleId == (int)UserRole.Administrator))
            {
