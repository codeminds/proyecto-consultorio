...
namespace API.Controllers
{
    ...
    public class PatientController : ControllerBase
    {
        ...
        public async Task<ActionResult<APIResponse>> ListPatients([FromQuery] FilterPatientDTO data)
        {
            ...
            List<Patient> list = await this._patientService.ListPatients(filter)
        ...
        {
            List<Patient> list = await this._patientService.SearchPatients(s).ToListAsync();
        ...
        public async Task<ActionResult<APIResponse>> UpdatePatient(int id, InsertUpdatePatientDTO data)
        {
            ...
            if (response.Success)
            {
                this._mapper.Map(data, patient);
                await this._patientService.UpdatePatient(patient);
                response.Data = this._mapper.Map<Patient, GetPatientDTO>(patient);
