...
export class Store {
    ...
    public get user() { return this._user.value; }
    public set user(value: User) { this._user.value = new User(value); }

    //Session
    public get session(): string { return jwtDecode<any>(localStorage.getItem('access_token')).session; }
